...
import { AUDIT_LOGS_MOCK_DATA } from "@/mocks/audit.mock";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          Track system events, administrative actions, and critical changes.
        </p>
      </div>
      ...
      <AuditLogTable logs={AUDIT_LOGS_MOCK_DATA} />

      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground">
          Showing <strong>1</strong> to <strong>5</strong> of{" "}
          <strong>{AUDIT_LOGS_MOCK_DATA.length}</strong> logs
        </div>
