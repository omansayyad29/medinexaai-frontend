...
import { CONVERSATIONS_MOCK_DATA } from "@/mocks/conversations.mock";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          Monitor AI interactions with patients across all channels and clinics.
        </p>
      </div>
      ...
      <ConversationTable conversations={CONVERSATIONS_MOCK_DATA} />

      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground">
          Showing <strong>1</strong> to <strong>5</strong> of{" "}
          <strong>{CONVERSATIONS_MOCK_DATA.length}</strong> conversations
        </div>
