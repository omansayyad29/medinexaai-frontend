...
import { DOCTORS_MOCK_DATA } from "@/mocks/doctors.mock";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          View all registered doctors across all clinics.
        </p>
      </div>
      ...
      <DoctorTable doctors={DOCTORS_MOCK_DATA} />

      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground">
          Showing <strong>1</strong> to <strong>5</strong> of{" "}
          <strong>{DOCTORS_MOCK_DATA.length}</strong> doctors
        </div>
