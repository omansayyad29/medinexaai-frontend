...
import { APPOINTMENTS_MOCK_DATA } from "@/mocks/appointments.mock";
    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground text-sm">
          Global view of all appointments across clinics.
        </p>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between w-full">
        <div className="flex items-center gap-2 w-full sm:w-auto">
          ...
          <button
            type="button"
            className="hidden sm:inline-flex h-9 items-center justify-center rounded-md border border-input bg-background px-3 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground"
          >
      ...
      <AppointmentTable appointments={APPOINTMENTS_MOCK_DATA} />

      <div className="flex items-center justify-between px-2">
        <div className="flex-1 text-sm text-muted-foreground">
          Showing <strong>1</strong> to <strong>5</strong> of{" "}
          <strong>{APPOINTMENTS_MOCK_DATA.length}</strong> appointments
        </div>
